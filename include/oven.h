...
static constexpr uint32_t HOST_SILICA_FIRST_PULSE_MAX_MS = 30000;
...
static constexpr uint32_t HOST_SILICA_FIRST_SOAK_MS = 90000;
static constexpr uint32_t HOST_SILICA_REHEAT_SOAK_MS = 45000;
...
static constexpr float HOST_SILICA_REHEAT_ENABLE_BELOW_TARGET_C = 5.0f;
static constexpr float HOST_SILICA_FIRST_PULSE_FORCE_OFF_BEFORE_TARGET_C = 3.0f;
static constexpr float HOST_SILICA_FORCE_OFF_BEFORE_TARGET_C = 1.5f;
