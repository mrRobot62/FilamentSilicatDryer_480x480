...
static const int I2C_SDA_PIN = 2;  // IO02
static const int I2C_SCL_PIN = 40; // IO40

// ==== I2C device addresses ====
static const uint8_t MCP9600_ADDR = 0x60;
static const uint8_t PCF8575_ADDR = 0x20;
...
void setup()
{
    ...
    Serial.println(F("=== ESP32-S3 I2C Test: MCP9600 + PCF8575 ==="));
