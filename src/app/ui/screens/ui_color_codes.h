...
#define UI_COLOR_TEMP_TARGET_HEX 0xFFA500
#define UI_COLOR_TEMP_CURRENT_HEX 0xFF3B30
#define UI_COLOR_TEMP_HOTSPOT_HEX 0x008CFF
#define UI_COLOR_TEMP_BAND_HEX 0x808080
