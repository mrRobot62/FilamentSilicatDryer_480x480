...
static constexpr uint8_t UI_PARAMETER_PULSE_FIELD_COUNT = 4;
...
typedef struct parameters_screen_widgets_t {
    ...
    lv_obj_t *display_value_label[UI_PARAMETER_DISPLAY_FIELD_COUNT];
    lv_obj_t *pulse_value_label[UI_PARAMETER_PULSE_FIELD_COUNT];
